...
|                                      |                                                              |                                                              |
| 信道编码                             |                                                              |                                                              |
|                                      | chapter focus                                                | 解释信道编码的基本原理和相关概念，如码距、码重和纠检错能力等;<br/>说明差错类型及差错控制类型;<br/>线性分组码相关概念、理论;<br/>1.能够根据生成矩阵，进行线性分组码编码;<br/>2.能够根据生成矩阵，获得线性分组码监督矩阵;<br/>3.记住线性分组码生成矩阵和监督矩阵的特点;<br/>4.能够正确进行线性分组码译码;<br/>5.能够设计简单线性分组码（码长较小）的标准阵或纠错方案。 |
